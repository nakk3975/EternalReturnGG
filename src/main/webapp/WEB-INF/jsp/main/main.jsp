		...
		$(document).ready(async function() {
			try {
		        ...
		        for (let i = 0; i < 10; i++) {
		            ...
		            // Get character name asynchronously
		            let characterName = await getCharacterName(characterCode);

		            let weaponName = getWeaponName(weaponCodes);

		            // Get Korean name asynchronously
		            let korName = await getKoreanCharacterName(characterCode);

		            let weaponBgImg = await fetchWeaponAndArmorBgImg(weaponItem, "weapon");
		            let armorBgImg1 = await fetchWeaponAndArmorBgImg(armorArray[0], "armor");
		            let armorBgImg2 = await fetchWeaponAndArmorBgImg(armorArray[1], "armor");
		            let armorBgImg3 = await fetchWeaponAndArmorBgImg(armorArray[2], "armor");
		            let armorBgImg4 = await fetchWeaponAndArmorBgImg(armorArray[3], "armor");
						 	...
						 	+ "<div class='route d-flex justify-content-between align-items-center'>"
						 		+"<div class='col-2'>"
							 		+ "<div class='d-flex align-items-end'>"
							 	 	...
							 	 	+ "</div>"
							 	+ "</div>"
							 	+ "<div id='textFileContent' class='col-2'>"+ korName + "</div>"
							 	+ "<div class='col-5 text-center'>"
						 	 		+ "<div class='destination-title mt-2' data-routeId=" + id + ">" + title + "</div>"
						 	 		+ "<div class='d-flex justify-content-around align-items-top text-center'>"
						 	 			+ "<div>"
						 	 				+ "<img class='main-item-back' src='https://cdn.dak.gg/er/images/item/ico-itemgradebg-0" + weaponBgImg + ".svg'>"
							 	 			+ "<img class='main-route-item' src='https://cdn.dak.gg/assets/er/game-assets/1.13.0/ItemIcon_" + weaponItem + ".png'>"
							 	 		+ "</div>"
							 	 		+ "<div>"
					 	 					+ "<img class='main-item-back' src='https://cdn.dak.gg/er/images/item/ico-itemgradebg-0" + armorBgImg1 + ".svg'>"
						 	 				+ "<img class='main-route-item' src='https://cdn.dak.gg/assets/er/game-assets/1.13.0/ItemIcon_" + armorArray[0] + ".png'>"
						 	 			+ "</div>"
						 	 			+ "<div>"
					 	 					+ "<img class='main-item-back' src='https://cdn.dak.gg/er/images/item/ico-itemgradebg-0" + armorBgImg2 + ".svg'>"
						 	 				+ "<img class='main-route-item' src='https://cdn.dak.gg/assets/er/game-assets/1.13.0/ItemIcon_" + armorArray[1] + ".png'>"
						 	 			+ "</div>"
						 	 			+ "<div>"
					 	 					+ "<img class='main-item-back' src='https://cdn.dak.gg/er/images/item/ico-itemgradebg-0" + armorBgImg3 + ".svg'>"
						 	 				+ "<img class='main-route-item' src='https://cdn.dak.gg/assets/er/game-assets/1.13.0/ItemIcon_" + armorArray[2] + ".png'>"
						 	 			+ "</div>"
						 	 			+ "<div>"
					 	 					+ "<img class='main-item-back' src='https://cdn.dak.gg/er/images/item/ico-itemgradebg-0" + armorBgImg4 + ".svg'>"
						 	 				+ "<img class='main-route-item' src='https://cdn.dak.gg/assets/er/game-assets/1.13.0/ItemIcon_" + armorArray[3] + ".png'>"
						 	 			+ "</div>"
					 	 			+ "</div>"
					 	 		+"</div>"
